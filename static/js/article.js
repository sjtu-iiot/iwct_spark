$(document).ready(function(){
	...
	for (var i=0; i<demo_info.length; i++)
	{
		...
		if (i % 2 == 0){
			...
			;
			content +=
				'" width="350" height="262" align="left"/><div class="projects_body_passage" >'
			;
			content +=
				demo_info[i].content
			;
			...
			content +=
				'<p><strong><span style="font-size:20px;text-align:left"> '
			;
			content +=
				demo_info[i].title
			;
			...
			;
			content +=
				'"  width="350" height="262" align="right"/><div class="projects_body_passage_left" >'
			;
			content +=
				demo_info[i].content
			;
